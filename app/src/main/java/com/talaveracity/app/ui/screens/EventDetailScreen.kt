...
import com.talaveracity.app.ui.viewmodel.EventDetailUiState
import com.talaveracity.app.ui.viewmodel.EventDetailViewModel
                            ...
                            FilledTonalIconButton(
                                onClick = { 
                                    val sendIntent: Intent = Intent().apply {
                                        ...
                                        putExtra(Intent.EXTRA_TEXT, "¡Mira este evento en TalaveraCity: ${estado.evento.title}!\n\n${estado.evento.description}")
                                        type = "text/plain"
                                    }
